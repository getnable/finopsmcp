...
CATALOG: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "asks": [
            ...
            ("What does each team or customer spend on AI?",
             "by project, workspace, API key, team, user or tag"),
        ...
        "tools": ["get_llm_costs", "get_llm_cost_by_model", "get_ai_cost_attribution",
