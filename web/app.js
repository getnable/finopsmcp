...
function Architecture({ version }) {
  return /* @__PURE__ */ React.createElement("section", { id: "arch", className: "alt" }, /* @__PURE__ */ React.createElement("div", { className: "wrap" }, /* @__PURE__ */ React.createElement("div", { className: "section-head" }, /* @__PURE__ */ React.createElement("div", { className: "label" }, "Architecture"), /* @__PURE__ */ React.createElement("h2", null, "Headless by design.", /* @__PURE__ */ React.createElement("br", null), /* @__PURE__ */ React.createElement("em", null, "Your data never moves.")), /* @__PURE__ */ React.createElement("p", null, "nable is not SaaS. It runs on the engineer's machine, holds credentials in the OS keyring, queries provider APIs directly, and surfaces tools to whichever AI editor is open. Your credentials never leave your machine. We never see your data.")), /* @__PURE__ */ React.createElement("div", { className: "arch" }, /* @__PURE__ */ React.createElement("div", { className: "arch-grid" }), /* @__PURE__ */ React.createElement("div", { className: "arch-row" }, /* @__PURE__ */ React.createElement("div", { className: "arch-col" }, /* @__PURE__ */ React.createElement("span", { className: "lab" }, "your editor"), /* @__PURE__ */ React.createElement("div", { className: "arch-node" }, /* @__PURE__ */ React.createElement("h4", null, "Claude \xB7 Cursor \xB7 Zed"), /* @__PURE__ */ React.createElement("span", { className: "sub" }, "MCP client"), /* @__PURE__ */ React.createElement("div", { className: "chips" }, /* @__PURE__ */ React.createElement("span", null, "tools/list"), /* @__PURE__ */ React.createElement("span", null, "tools/call")))), /* @__PURE__ */ React.createElement("div", { className: "arch-arrow" }, /* @__PURE__ */ React.createElement("span", null, "stdio"), /* @__PURE__ */ React.createElement("span", { className: "line" }), /* @__PURE__ */ React.createElement("span", null, "jsonrpc")), /* @__PURE__ */ React.createElement("div", { className: "arch-col" }, /* @__PURE__ */ React.createElement("span", { className: "lab" }, "runtime \xB7 local"), /* @__PURE__ */ React.createElement("div", { className: "arch-node center" }, /* @__PURE__ */ React.createElement("h4", null, "nable runtime"), /* @__PURE__ */ React.createElement("span", { className: "sub" }, "finops-mcp / ", version || "0.8.36"), /* @__PURE__ */ React.createElement("div", { className: "chips" }, /* @__PURE__ */ React.createElement("span", null, "keyring"), /* @__PURE__ */ React.createElement("span", null, "fernet"), /* @__PURE__ */ React.createElement("span", null, "read-only"), /* @__PURE__ */ React.createElement("span", null, "audit-log")))), /* @__PURE__ */ React.createElement("div", { className: "arch-arrow" }, /* @__PURE__ */ React.createElement("span", null, "https"), /* @__PURE__ */ React.createElement("span", { className: "line" }), /* @__PURE__ */ React.createElement("span", null, "signed")), /* @__PURE__ */ React.createElement("div", { className: "arch-col" }, /* @__PURE__ */ React.createElement("span", { className: "lab" }, "provider apis"), /* @__PURE__ */ React.createElement("div", { className: "arch-node" }, /* @__PURE__ */ React.createElement("h4", null, "17 connectors"), /* @__PURE__ */ React.createElement("span", { className: "sub" }, "cost \xB7 usage \xB7 billing"), /* @__PURE__ */ React.createElement("div", { className: "chips" }, /* @__PURE__ */ React.createElement("span", null, "AWS CE/CUR"), /* @__PURE__ */ React.createElement("span", null, "Azure CM"), /* @__PURE__ */ React.createElement("span", null, "GCP BQ"), /* @__PURE__ */ React.createElement("span", null, "+14"))))))));
}
const QUESTIONS = [
