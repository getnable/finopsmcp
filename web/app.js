...
function LogoMark() {
  return /* @__PURE__ */ React.createElement("svg", { width: "26", height: "26", viewBox: "0 0 120 120", className: "mark-img", "aria-hidden": "true" }, /* @__PURE__ */ React.createElement("rect", { x: "2", y: "2", width: "116", height: "116", rx: "25", fill: "#0a0a0c", stroke: "#2c7d91", strokeOpacity: ".55", strokeWidth: "3" }), /* @__PURE__ */ React.createElement("path", { d: "M36 92 V30", stroke: "#4db8d4", strokeWidth: "14", strokeLinecap: "round" }), /* @__PURE__ */ React.createElement("path", { d: "M36 32 L84 86", stroke: "#4db8d4", strokeWidth: "14", strokeLinecap: "round" }), /* @__PURE__ */ React.createElement("path", { d: "M84 90 V28", stroke: "#2c7d91", strokeWidth: "14", strokeLinecap: "round" }), /* @__PURE__ */ React.createElement("circle", { cx: "84", cy: "88", r: "9", fill: "#4db8d4" }));
}
function Ticker({ installs, version }) {
  return /* @__PURE__ */ React.createElement("div", { className: "ticker" }, /* @__PURE__ */ React.createElement("div", { className: "ticker-inner" }, /* @__PURE__ */ React.createElement("span", { className: "seg" }, /* @__PURE__ */ React.createElement("span", { className: "dot" }), /* @__PURE__ */ React.createElement("b", null, "nable"), /* @__PURE__ */ React.createElement("span", null, "runtime healthy")), /* @__PURE__ */ React.createElement("span", { className: "sep" }, "\xB7"), /* @__PURE__ */ React.createElement("span", { className: "seg" }, "70k+ PyPI downloads"), /* @__PURE__ */ React.createElement("span", { className: "sep" }, "\xB7"), /* @__PURE__ */ React.createElement("span", { className: "seg" }, "AWS \xB7 Azure \xB7 GCP \xB7 SaaS \xB7 AI spend, one bill"), /* @__PURE__ */ React.createElement("span", { className: "sep" }, "\xB7"), /* @__PURE__ */ React.createElement("span", { className: "seg" }, /* @__PURE__ */ React.createElement("a", { href: "/about", style: { color: "var(--accent)", textDecoration: "none", fontWeight: 500 } }, "About \u2192"))));
}
...
function Nav() {
  ...
  } }, "Docs")), /* @__PURE__ */ React.createElement("li", null, /* @__PURE__ */ React.createElement("a", { href: "https://github.com/getnable/finopsmcp", target: "_blank", rel: "noopener noreferrer", onClick: () => {
    if (window.posthog) posthog.capture("nav_clicked", { item: "github" });
  } }, "GitHub"))), /* @__PURE__ */ React.createElement("div", { className: "right" }, /* @__PURE__ */ React.createElement("a", { href: "/account", className: "nav-signin" }, "Sign in"), /* @__PURE__ */ React.createElement(
    "a",
    {
      href: "/demo",
...
function Hero() {
  return /* @__PURE__ */ React.createElement("header", { className: "hero hero-centered", id: "top" }, /* @__PURE__ */ React.createElement("div", { className: "hero-grid", "aria-hidden": "true" }), /* @__PURE__ */ React.createElement("div", { className: "wrap" }, /* @__PURE__ */ React.createElement("div", { className: "hero-c" }, /* @__PURE__ */ React.createElement("h1", { className: "display" }, "The cost brain ", /* @__PURE__ */ React.createElement("span", { className: "h1-ask" }, "for the AI era.")), /* @__PURE__ */ React.createElement("p", { className: "hero-sub" }, "Ask nable about your cloud and AI bill right in Claude or Cursor. It finds the waste, prices it on your real rates, and ships the fix as a PR you approve."), /* @__PURE__ */ React.createElement("div", { className: "hero-actions" }, /* @__PURE__ */ React.createElement(CopyCmd, { cmd: "uvx nable" })), /* @__PURE__ */ React.createElement("p", { className: "hero-cmdnote" }, "Read-only \xB7 no signup \xB7 no cloud keys \xB7 free for solo use"))), /* @__PURE__ */ React.createElement("div", { className: "wrap hero-stage" }, /* @__PURE__ */ React.createElement(Console, { interaction: "cycling" })));
}
...
const QUERIES = [
  ...
  },
  {
    ...
    response: /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("p", null, "Blended across Savings Plans, RIs, and committed-use discounts on GCP. Coverage measured against on-demand list:"), /* @__PURE__ */ React.createElement("div", { className: "ttable" }, /* @__PURE__ */ React.createElement("div", { className: "r hd" }, /* @__PURE__ */ React.createElement("span", null, "Commitment"), /* @__PURE__ */ React.createElement("span", null, "Coverage"), /* @__PURE__ */ React.createElement("span", null, "Effective rate")), /* @__PURE__ */ React.createElement("div", { className: "r" }, /* @__PURE__ */ React.createElement("span", null, "AWS \xB7 Savings Plans (1y)"), /* @__PURE__ */ React.createElement("span", { className: "v num" }, "82%"), /* @__PURE__ */ React.createElement("span", { className: "d down num" }, "-24.1%")), /* @__PURE__ */ React.createElement("div", { className: "r" }, /* @__PURE__ */ React.createElement("span", null, "AWS \xB7 RIs (RDS, ElastiCache)"), /* @__PURE__ */ React.createElement("span", { className: "v num" }, "71%"), /* @__PURE__ */ React.createElement("span", { className: "d down num" }, "-31.8%")), /* @__PURE__ */ React.createElement("div", { className: "r" }, /* @__PURE__ */ React.createElement("span", null, "GCP \xB7 CUDs (compute)"), /* @__PURE__ */ React.createElement("span", { className: "v num" }, "64%"), /* @__PURE__ */ React.createElement("span", { className: "d down num" }, "-20.4%")), /* @__PURE__ */ React.createElement("div", { className: "r total" }, /* @__PURE__ */ React.createElement("span", null, "Blended effective discount"), /* @__PURE__ */ React.createElement("span", { className: "v num" }, "-"), /* @__PURE__ */ React.createElement("span", { className: "d down num" }, "-26.7%"))), /* @__PURE__ */ React.createElement("p", { style: { marginTop: 12 } }, "Raising Compute SP coverage to 92% is worth another ", /* @__PURE__ */ React.createElement("span", { style: { color: "var(--accent)" } }, "$8,200 / mo"), ". Model it?"))
  },
  {
    q: "What can you actually do?",
    response: /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("p", null, "A lot, and all of it from your editor. On a connected account I can:"), /* @__PURE__ */ React.createElement("ul", { className: "caps" }, /* @__PURE__ */ React.createElement("li", null, /* @__PURE__ */ React.createElement("b", null, "Answer cost questions"), " across AWS, Azure, GCP, Kubernetes and 15 SaaS and AI providers"), /* @__PURE__ */ React.createElement("li", null, /* @__PURE__ */ React.createElement("b", null, "Catch anomalies"), " with Z-score detection and name the tag driving the spike"), /* @__PURE__ */ React.createElement("li", null, /* @__PURE__ */ React.createElement("b", null, "Find savings"), ": rightsizing, idle cleanup, commitment and discount coverage"), /* @__PURE__ */ React.createElement("li", null, /* @__PURE__ */ React.createElement("b", null, "Track AI spend"), " by model and forecast where your token bill lands"), /* @__PURE__ */ React.createElement("li", null, /* @__PURE__ */ React.createElement("b", null, "Act"), ": open a rightsizing PR against your IaC, file a ticket, post to Slack")), /* @__PURE__ */ React.createElement("p", { style: { marginTop: 12 } }, /* @__PURE__ */ React.createElement("span", { style: { color: "var(--accent)" } }, "180+ tools"), " in all. Pick a prompt below to run a real one."))
  }
];
...
function AiCost() {
  ...
  return /* @__PURE__ */ React.createElement("section", { id: "ai", className: "alt" }, /* @__PURE__ */ React.createElement("div", { className: "wrap" }, /* @__PURE__ */ React.createElement("div", { className: "section-head center" }, /* @__PURE__ */ React.createElement("div", { className: "label" }, "Your AI bill"), /* @__PURE__ */ React.createElement("h2", null, "Tools chart your AI spend.", /* @__PURE__ */ React.createElement("br", null), /* @__PURE__ */ React.createElement("em", null, "nable finds the waste.")), /* @__PURE__ */ React.createElement("p", null, "Most of an AI bill is input tokens billed at full price, plus calls sent to a frontier model a cheaper one would have answered the same way. nable reads the split from your real usage and shows you the cheapest way to get the same output. No caching guesswork.")), /* @__PURE__ */ React.createElement("ul", { className: "ee-points ee-points-center" }, /* @__PURE__ */ React.createElement("li", null, /* @__PURE__ */ React.createElement("span", { className: "ee-plus" }, "+"), /* @__PURE__ */ React.createElement("span", null, "Input, output and cache, ", /* @__PURE__ */ React.createElement("b", null, "split from your actual bill"))), /* @__PURE__ */ React.createElement("li", null, /* @__PURE__ */ React.createElement("span", { className: "ee-plus" }, "+"), /* @__PURE__ */ React.createElement("span", null, "Flags ", /* @__PURE__ */ React.createElement("b", null, "frontier-model calls"), " a cheaper model handles the same")), /* @__PURE__ */ React.createElement("li", null, /* @__PURE__ */ React.createElement("span", { className: "ee-plus" }, "+"), /* @__PURE__ */ React.createElement("span", null, "Separates ", /* @__PURE__ */ React.createElement("b", null, "what you can bank today"), " from what needs a closer look"))), /* @__PURE__ */ React.createElement("div", { className: "aicost-cta aicost-panel-center", style: { justifyContent: "center" } }, /* @__PURE__ */ React.createElement("span", { className: "aicost-cta-l" }, "See your own AI bill, split by model, free:"), /* @__PURE__ */ React.createElement("code", { className: "aicost-cmd", onClick: copy }, "uvx nable"))));
}
function Architecture({ version }) {
  const [tab, setTab] = useState("flow");
  return /* @__PURE__ */ React.createElement("section", { id: "arch", className: "alt" }, /* @__PURE__ */ React.createElement("div", { className: "wrap" }, /* @__PURE__ */ React.createElement("div", { className: "section-head center" }, /* @__PURE__ */ React.createElement("div", { className: "label" }, "Architecture"), /* @__PURE__ */ React.createElement("h2", null, "How it works,", /* @__PURE__ */ React.createElement("br", null), /* @__PURE__ */ React.createElement("em", null, "and where your data lives.")), /* @__PURE__ */ React.createElement("p", null, "One runtime, local or hosted. Your editor talks to it over MCP; it reads your providers read-only, and never changes anything on its own.")), /* @__PURE__ */ React.createElement("div", { className: "arch-tabs", role: "tablist" }, /* @__PURE__ */ React.createElement("button", { role: "tab", "aria-selected": tab === "flow", className: "arch-tab" + (tab === "flow" ? " active" : ""), onClick: () => setTab("flow") }, "The flow"), /* @__PURE__ */ React.createElement("button", { role: "tab", "aria-selected": tab === "data", className: "arch-tab" + (tab === "data" ? " active" : ""), onClick: () => setTab("data") }, "Your data"), /* @__PURE__ */ React.createElement("button", { role: "tab", "aria-selected": tab === "run", className: "arch-tab" + (tab === "run" ? " active" : ""), onClick: () => setTab("run") }, "Run or host")), /* @__PURE__ */ React.createElement("div", { className: "arch-panel" }, tab === "data" && /* @__PURE__ */ React.createElement("div", { className: "guarantees" }, /* @__PURE__ */ React.createElement("div", { className: "guarantees-head" }, /* @__PURE__ */ React.createElement("h3", null, "Your data, in plain terms"), /* @__PURE__ */ React.createElement("a", { className: "guarantees-link", href: "/security" }, "Full security model ", /* @__PURE__ */ React.createElement("span", { className: "arr" }, "\u2192"))), /* @__PURE__ */ React.createElement("div", { className: "guarantees-cols" }, /* @__PURE__ */ React.createElement("div", { className: "guarantee-col" }, /* @__PURE__ */ React.createElement("span", { className: "guarantee-tag" }, "Local \xB7 Dev and Pro"), /* @__PURE__ */ React.createElement("ul", null, /* @__PURE__ */ React.createElement("li", null, /* @__PURE__ */ React.createElement(CheckIcon, null), /* @__PURE__ */ React.createElement("span", null, "Your credentials and cost data never reach our servers")), /* @__PURE__ */ React.createElement("li", null, /* @__PURE__ */ React.createElement(CheckIcon, null), /* @__PURE__ */ React.createElement("span", null, "We never sell, rent, or share your data")), /* @__PURE__ */ React.createElement("li", null, /* @__PURE__ */ React.createElement(CheckIcon, null), /* @__PURE__ */ React.createElement("span", null, "Nothing you connect is used to train models")), /* @__PURE__ */ React.createElement("li", null, /* @__PURE__ */ React.createElement(CheckIcon, null), /* @__PURE__ */ React.createElement("span", null, "You own your inputs and outputs")), /* @__PURE__ */ React.createElement("li", null, /* @__PURE__ */ React.createElement(CheckIcon, null), /* @__PURE__ */ React.createElement("span", null, "Propose-only: nable never changes your cloud on its own")))), /* @__PURE__ */ React.createElement("div", { className: "guarantee-col" }, /* @__PURE__ */ React.createElement("span", { className: "guarantee-tag" }, "Hosted \xB7 Startups and Enterprise"), /* @__PURE__ */ React.createElement("ul", null, /* @__PURE__ */ React.createElement("li", null, /* @__PURE__ */ React.createElement(CheckIcon, null), /* @__PURE__ */ React.createElement("span", null, "Single-tenant: your data is never pooled with another customer's")), /* @__PURE__ */ React.createElement("li", null, /* @__PURE__ */ React.createElement(CheckIcon, null), /* @__PURE__ */ React.createElement("span", null, "Your own isolated runtime and store")), /* @__PURE__ */ React.createElement("li", null, /* @__PURE__ */ React.createElement(CheckIcon, null), /* @__PURE__ */ React.createElement("span", null, "Sub-processors: Anthropic for managed AI, the host, and Stripe")), /* @__PURE__ */ React.createElement("li", null, /* @__PURE__ */ React.createElement(CheckIcon, null), /* @__PURE__ */ React.createElement("span", null, "SSO, RBAC, and audit logs")))))), tab === "flow" && /* @__PURE__ */ React.createElement("div", { className: "arch" }, /* @__PURE__ */ React.createElement("div", { className: "arch-grid" }), /* @__PURE__ */ React.createElement("div", { className: "arch-row" }, /* @__PURE__ */ React.createElement("div", { className: "arch-col" }, /* @__PURE__ */ React.createElement("span", { className: "lab" }, "your editor"), /* @__PURE__ */ React.createElement("div", { className: "arch-node" }, /* @__PURE__ */ React.createElement("h4", null, "Claude \xB7 Cursor \xB7 Zed"), /* @__PURE__ */ React.createElement("span", { className: "sub" }, "MCP client"), /* @__PURE__ */ React.createElement("div", { className: "chips" }, /* @__PURE__ */ React.createElement("span", null, "tools/list"), /* @__PURE__ */ React.createElement("span", null, "tools/call")))), /* @__PURE__ */ React.createElement("div", { className: "arch-arrow" }, /* @__PURE__ */ React.createElement("span", null, "stdio"), /* @__PURE__ */ React.createElement("span", { className: "line" }), /* @__PURE__ */ React.createElement("span", null, "jsonrpc")), /* @__PURE__ */ React.createElement("div", { className: "arch-col" }, /* @__PURE__ */ React.createElement("span", { className: "lab" }, "runtime \xB7 local or hosted"), /* @__PURE__ */ React.createElement("div", { className: "arch-node center" }, /* @__PURE__ */ React.createElement("h4", null, "nable runtime"), /* @__PURE__ */ React.createElement("span", { className: "sub" }, "your machine or a single-tenant host"), /* @__PURE__ */ React.createElement("div", { className: "chips" }, /* @__PURE__ */ React.createElement("span", null, "keyring"), /* @__PURE__ */ React.createElement("span", null, "fernet"), /* @__PURE__ */ React.createElement("span", null, "read-only"), /* @__PURE__ */ React.createElement("span", null, "audit-log")))), /* @__PURE__ */ React.createElement("div", { className: "arch-arrow" }, /* @__PURE__ */ React.createElement("span", null, "https"), /* @__PURE__ */ React.createElement("span", { className: "line" }), /* @__PURE__ */ React.createElement("span", null, "signed")), /* @__PURE__ */ React.createElement("div", { className: "arch-col" }, /* @__PURE__ */ React.createElement("span", { className: "lab" }, "provider apis"), /* @__PURE__ */ React.createElement("div", { className: "arch-node" }, /* @__PURE__ */ React.createElement("h4", null, "Every provider"), /* @__PURE__ */ React.createElement("span", { className: "sub" }, "cost \xB7 usage \xB7 billing"), /* @__PURE__ */ React.createElement("div", { className: "chips" }, /* @__PURE__ */ React.createElement("span", null, "AWS CE/CUR"), /* @__PURE__ */ React.createElement("span", null, "Azure CM"), /* @__PURE__ */ React.createElement("span", null, "GCP BQ"), /* @__PURE__ */ React.createElement("span", null, "+14")))))), tab === "run" && /* @__PURE__ */ React.createElement("div", { className: "host-opts" }, /* @__PURE__ */ React.createElement("div", { className: "host-opt" }, /* @__PURE__ */ React.createElement("span", { className: "host-tag" }, "Run it yourself"), /* @__PURE__ */ React.createElement("h4", null, "Local-first, on your machine"), /* @__PURE__ */ React.createElement("p", null, "Install with one command. Credentials, cache, and queries all stay on your machine, no nable backend in the path."), /* @__PURE__ */ React.createElement("div", { className: "gate-cmd" }, /* @__PURE__ */ React.createElement(CopyCmd, { cmd: "uvx nable" })), /* @__PURE__ */ React.createElement("p", { className: "host-note" }, "Lives in Claude, Cursor, or Zed. No separate dashboard to run.")), /* @__PURE__ */ React.createElement("div", { className: "host-opt" }, /* @__PURE__ */ React.createElement("span", { className: "host-tag" }, "Or let us host it"), /* @__PURE__ */ React.createElement("h4", null, "Managed, single-tenant"), /* @__PURE__ */ React.createElement("p", null, "Want it always on? We run a single-tenant instance for your org, isolated from every other customer, plus SSO, RBAC, and share links."), /* @__PURE__ */ React.createElement(
    "a",
    {
...
function Connectors() {
  return /* @__PURE__ */ React.createElement("section", { id: "connectors", className: "alt" }, /* @__PURE__ */ React.createElement("div", { className: "wrap" }, /* @__PURE__ */ React.createElement("div", { className: "section-head center" }, /* @__PURE__ */ React.createElement("div", { className: "label" }, "One dataset"), /* @__PURE__ */ React.createElement("h2", null, "Every provider,", /* @__PURE__ */ React.createElement("br", null), /* @__PURE__ */ React.createElement("em", null, "one normalized bill.")), /* @__PURE__ */ React.createElement("p", null, "Every provider lands in the same FOCUS 1.2 records, the open FinOps standard, which nable extends past the clouds to usage-based SaaS and per-model AI spend. That is why one question can span AWS, Snowflake, Datadog and your OpenAI tokens: they all answer in the same shape."), /* @__PURE__ */ React.createElement("div", { className: "focus-chips", "aria-hidden": "true" }, /* @__PURE__ */ React.createElement("span", null, "FOCUS 1.2"), /* @__PURE__ */ React.createElement("span", null, "AWS \xB7 Azure \xB7 GCP"), /* @__PURE__ */ React.createElement("span", null, "11 SaaS providers"), /* @__PURE__ */ React.createElement("span", null, "AI spend, per model"), /* @__PURE__ */ React.createElement("span", null, "tokens preserved")))), /* @__PURE__ */ React.createElement("div", { className: "logo-marquee" }, /* @__PURE__ */ React.createElement("div", { className: "logo-track" }, [...LOGOS, ...LOGOS, ...LOGOS].map((l, i) => /* @__PURE__ */ React.createElement("img", { className: "logo-img" + (l.icon ? " is-icon" : ""), key: i, src: "/vendor/logos/" + l.f + ".svg", alt: l.n, title: l.n, loading: "lazy" })))), /* @__PURE__ */ React.createElement("div", { className: "wrap" }, /* @__PURE__ */ React.createElement("p", { className: "logo-band-note" }, "Clouds, SaaS and AI spend in one normalized bill \xB7 new providers ship monthly \xB7 ", /* @__PURE__ */ React.createElement("a", { className: "logo-band-link", href: "/docs#env-vars", onClick: () => {
    if (window.posthog) posthog.capture("cta_clicked", { location: "connectors", cta: "provider_setup" });
  } }, "setup guide for every provider \u2192"))));
}
function DashboardShowcase() {
  return /* @__PURE__ */ React.createElement("section", { id: "dashboard", className: "alt dash-sec" }, /* @__PURE__ */ React.createElement("div", { className: "wrap" }, /* @__PURE__ */ React.createElement("div", { className: "section-head center" }, /* @__PURE__ */ React.createElement("div", { className: "label" }, "The dashboard"), /* @__PURE__ */ React.createElement("h2", null, "Engineers ask in the editor.", /* @__PURE__ */ React.createElement("br", null), /* @__PURE__ */ React.createElement("em", null, "Finance lives here.")), /* @__PURE__ */ React.createElement("p", null, "The same cost brain, as an always-on dashboard the whole team reads, no terminal. A cross-cloud overview, unit economics, an efficiency grade, and an AI analyst anyone can ask. Single-tenant, in your environment, never pooled with another customer.")), /* @__PURE__ */ React.createElement("div", { className: "dash-stage" }, /* @__PURE__ */ React.createElement("div", { className: "dash-frame" }, /* @__PURE__ */ React.createElement("div", { className: "dash-bar" }, /* @__PURE__ */ React.createElement("i", null), /* @__PURE__ */ React.createElement("i", null), /* @__PURE__ */ React.createElement("i", null), /* @__PURE__ */ React.createElement("span", null, "nable \xB7 cost dashboard")), /* @__PURE__ */ React.createElement(
    "img",
    {
      src: "/marketing/img/dashboard-overview.png",
  ...
  ))), /* @__PURE__ */ React.createElement("div", { className: "dash-feats" }, /* @__PURE__ */ React.createElement("div", { className: "dash-feat" }, /* @__PURE__ */ React.createElement("b", null, "Ask anything, streamed."), /* @__PURE__ */ React.createElement("span", null, "The AI analyst answers across every provider and drafts the fix as a pull request. It never changes your cloud on its own.")), /* @__PURE__ */ React.createElement("div", { className: "dash-feat" }, /* @__PURE__ */ React.createElement("b", null, "Click, don't wait."), /* @__PURE__ */ React.createElement("span", null, "Every tile drills into instant detail. The end of dashboards nobody opens.")), /* @__PURE__ */ React.createElement("div", { className: "dash-feat" }, /* @__PURE__ */ React.createElement("b", null, "Exec-ready."), /* @__PURE__ */ React.createElement("span", null, "Cost per unit, commitment coverage, an efficiency grade, and the untagged spend finance actually asks about.")))));
}
function CheckIcon() {
...
function PricingCards({ tiers, annual }) {
  return /* @__PURE__ */ React.createElement("div", { className: "pcards" }, tiers.map((t) => /* @__PURE__ */ React.createElement("div", { className: "pcard" + (t.rec ? " pcard-rec" : ""), key: t.key }, t.rec && /* @__PURE__ */ React.createElement("div", { className: "pcard-badge" }, "Recommended"), /* @__PURE__ */ React.createElement("div", { className: "pcard-name" }, t.name), /* @__PURE__ */ React.createElement("div", { className: "pcard-tag" }, t.tag), /* @__PURE__ */ React.createElement("div", { className: "pcard-price" }, /* @__PURE__ */ React.createElement("span", { className: "pcard-amt" }, t.amt), t.per && /* @__PURE__ */ React.createElement("span", { className: "pcard-per" }, t.per)), /* @__PURE__ */ React.createElement("div", { className: "pcard-billed" }, t.billed), /* @__PURE__ */ React.createElement("ul", { className: "pcard-feats" }, t.feats.map((f, i) => /* @__PURE__ */ React.createElement("li", { key: i }, /* @__PURE__ */ React.createElement(CheckIcon, null), /* @__PURE__ */ React.createElement("span", null, f)))), /* @__PURE__ */ React.createElement(
    "a",
    {
      ...
      onClick: () => {
        if (window.posthog) posthog.capture("cta_clicked", { location: "pricing", plan: t.plan, billing: annual ? "annual" : "monthly" });
      }
    },
    t.cta
  ))));
...
function Footer({ version }) {
  ...
  } }, "Star on GitHub ", /* @__PURE__ */ React.createElement("span", { style: { color: "var(--warn)" } }, "\u2605")), /* @__PURE__ */ React.createElement("a", { href: "https://www.linkedin.com/company/getnable/", target: "_blank", rel: "noopener noreferrer" }, "LinkedIn"))), /* @__PURE__ */ React.createElement("div", { className: "foot-meta" }, /* @__PURE__ */ React.createElement("span", null, "2026 nable \xB7 ", /* @__PURE__ */ React.createElement("a", { href: "/privacy", style: { color: "var(--fg-3)" } }, "Privacy"), " \xB7 ", /* @__PURE__ */ React.createElement("a", { href: "/terms", style: { color: "var(--fg-3)" } }, "Terms")))));
}
...
function DemoVideo() {
  return /* @__PURE__ */ React.createElement("section", { id: "demo", className: "demo-sec" }, /* @__PURE__ */ React.createElement("div", { className: "wrap" }, /* @__PURE__ */ React.createElement("div", { className: "section-head center" }, /* @__PURE__ */ React.createElement("div", { className: "label" }, "See it work"), /* @__PURE__ */ React.createElement("h2", null, "Watch nable", /* @__PURE__ */ React.createElement("br", null), /* @__PURE__ */ React.createElement("em", null, "find the money.")), /* @__PURE__ */ React.createElement("p", null, "Just ask. nable reads your real bill, finds what changed, and drafts the fix, live.")), /* @__PURE__ */ React.createElement("div", { className: "demo-video-frame" }, /* @__PURE__ */ React.createElement(DemoTheater, null)), /* @__PURE__ */ React.createElement("div", { className: "postdemo" }, /* @__PURE__ */ React.createElement("span", { className: "postdemo-l" }, "Same answers, on your real bill, in about a minute:"), /* @__PURE__ */ React.createElement("code", { className: "aicost-cmd postdemo-cmd", onClick: () => {
    ...
    if (window.posthog) posthog.capture("cta_clicked", { location: "post_demo", cta: "setup_guide" });
  } }, "2-minute setup guide ", /* @__PURE__ */ React.createElement("span", { className: "arr" }, "\u2192")))));
}
