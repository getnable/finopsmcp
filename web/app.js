...
function Nav() {
  ...
  } }, "Pricing"), /* @__PURE__ */ React.createElement("button", { className: "nav-mobile-item", onClick: () => scrollTo("arch") }, "Security"), /* @__PURE__ */ React.createElement("a", { className: "nav-mobile-item", href: "/docs.html", onClick: () => {
    setOpen(false);
...
const PRICE_ROWS = [
  ...
  { label: "Hosting + managed AI (add-on)", dev: false, pro: "+$200/mo \xB7 500 credits", startup: "+$4,000/mo \xB7 10,000 credits", ent: "Custom" },
