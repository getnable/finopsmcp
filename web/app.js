...
function Hero() {
  return /* @__PURE__ */ React.createElement("header", { className: "hero hero-centered", id: "top" }, /* @__PURE__ */ React.createElement("div", { className: "hero-grid", "aria-hidden": "true" }), /* @__PURE__ */ React.createElement("div", { className: "wrap" }, /* @__PURE__ */ React.createElement("div", { className: "hero-c" }, /* @__PURE__ */ React.createElement("h1", { className: "display" }, "Finds the waste in your cloud and AI bill. ", /* @__PURE__ */ React.createElement("span", { className: "h1-ask" }, "Ships the fix as a PR.")), /* @__PURE__ */ React.createElement("p", { className: "hero-sub" }, "Local-first FinOps for the AI era: ask nable in Claude or Cursor, and your data never leaves your machine."), /* @__PURE__ */ React.createElement("div", { className: "hero-actions" }, /* @__PURE__ */ React.createElement(CopyCmd, { cmd: "uvx nable" })), /* @__PURE__ */ React.createElement("p", { className: "hero-cmdnote" }, "Read-only \xB7 no signup \xB7 no cloud keys \xB7 free for solo use"))));
}
