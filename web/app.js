...
function Hero({ layout, interaction }) {
  ...
  } }, "Start free ", /* @__PURE__ */ React.createElement("span", { className: "arr" }, "\u2192")), /* @__PURE__ */ React.createElement("a", { className: "btn btn-ghost", href: "#runtime", onClick: () => {
    if (window.posthog) posthog.capture("cta_clicked", { location: "hero", cta: "view_demo" });
  } }, "View demo")), showInstall && /* @__PURE__ */ React.createElement("div", { className: "hero-install-reveal" }, /* @__PURE__ */ React.createElement(InstallRow, null), /* @__PURE__ */ React.createElement("p", { className: "install-note" }, "Free for solo use, no credit card \xB7 ", /* @__PURE__ */ React.createElement("a", { href: "/docs.html#install", onClick: () => {
