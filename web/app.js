...
function Pricing() {
  ...
  const tiers = [
    ...
    },
    {
      key: "pro",
      name: "Pro",
      tag: "Watch, fix, and guard your agents",
      amt: proPrice,
      per,
      billed,
