...
def machine(tmp_path, monkeypatch):
    """An empty home, project and user settings files, uv on PATH, and no
    Cursor/Codex adapter unless a test installs a stub."""
    home = tmp_path / "home"
    home.mkdir()
    ...
    monkeypatch.setitem(sys.modules, "finops.guard_adapters", None)   # import -> ImportError
