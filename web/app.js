...
function Hero() {
  return /* @__PURE__ */ React.createElement("header", { className: "hero hero-centered", id: "top" }, /* @__PURE__ */ React.createElement("div", { className: "wrap" }, /* @__PURE__ */ React.createElement("div", { className: "hero-c" }, /* @__PURE__ */ React.createElement("h1", { className: "display" }, "Every cloud and AI bill, ", /* @__PURE__ */ React.createElement("span", { className: "h1-ask" }, "one question away.")), /* @__PURE__ */ React.createElement("p", { className: "hero-sub" }, "nable normalizes AWS, Snowflake, Datadog, and your OpenAI tokens into one bill, then answers anything you ask, right inside Claude or Cursor."), /* @__PURE__ */ React.createElement("div", { className: "hero-actions" }, /* @__PURE__ */ React.createElement(CopyCmd, { cmd: "uvx nable" }), /* @__PURE__ */ React.createElement("a", { className: "btn btn-primary", href: "/docs.html", onClick: () => {
...
const QUERIES = [
  ...
  },
  {
    ...
    response: /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("p", null, "A lot, and all of it from your editor. On a connected account I can:"), /* @__PURE__ */ React.createElement("ul", { className: "caps" }, /* @__PURE__ */ React.createElement("li", null, /* @__PURE__ */ React.createElement("b", null, "Answer cost questions"), " across AWS, Azure, GCP, Kubernetes and 13+ SaaS and AI providers"), /* @__PURE__ */ React.createElement("li", null, /* @__PURE__ */ React.createElement("b", null, "Catch anomalies"), " with Z-score detection and name the tag driving the spike"), /* @__PURE__ */ React.createElement("li", null, /* @__PURE__ */ React.createElement("b", null, "Find savings"), ": rightsizing, idle cleanup, commitment and discount coverage"), /* @__PURE__ */ React.createElement("li", null, /* @__PURE__ */ React.createElement("b", null, "Track AI spend"), " by model and forecast where your token bill lands"), /* @__PURE__ */ React.createElement("li", null, /* @__PURE__ */ React.createElement("b", null, "Act"), ": open a rightsizing PR against your IaC, file a ticket, post to Slack")), /* @__PURE__ */ React.createElement("p", { style: { marginTop: 12 } }, /* @__PURE__ */ React.createElement("span", { style: { color: "var(--accent)" } }, "180+ tools"), " in all. Pick a prompt below to run a real one."))
  }
];
