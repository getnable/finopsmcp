...
function Hero() {
  return /* @__PURE__ */ React.createElement("header", { className: "hero hero-centered", id: "top" }, /* @__PURE__ */ React.createElement("div", { className: "hero-grid", "aria-hidden": "true" }), /* @__PURE__ */ React.createElement("div", { className: "wrap" }, /* @__PURE__ */ React.createElement("div", { className: "hero-c" }, /* @__PURE__ */ React.createElement("h1", { className: "display" }, "The cost brain ", /* @__PURE__ */ React.createElement("span", { className: "h1-ask" }, "for the AI era.")), /* @__PURE__ */ React.createElement("p", { className: "hero-sub" }, "Cloud and AI cost management, where you code. Find the waste in Claude or Cursor, ship the fix as a PR, all on your machine."), /* @__PURE__ */ React.createElement("div", { className: "hero-actions" }, /* @__PURE__ */ React.createElement(CopyCmd, { cmd: "uvx nable" })), /* @__PURE__ */ React.createElement("p", { className: "hero-cmdnote" }, "Read-only \xB7 no signup \xB7 no cloud keys \xB7 free for solo use"))));
}
