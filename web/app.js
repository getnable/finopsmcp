...
function Hero() {
  return /* @__PURE__ */ React.createElement("header", { className: "hero hero-centered", id: "top" }, /* @__PURE__ */ React.createElement("div", { className: "hero-grid", "aria-hidden": "true" }), /* @__PURE__ */ React.createElement("div", { className: "wrap" }, /* @__PURE__ */ React.createElement("div", { className: "hero-c" }, /* @__PURE__ */ React.createElement("h1", { className: "display" }, "Local-first FinOps ", /* @__PURE__ */ React.createElement("span", { className: "h1-ask" }, "for the AI era.")), /* @__PURE__ */ React.createElement("p", { className: "hero-sub" }, "Cloud and AI spend, queryable in Claude. Savings shipped as pull requests, without your data ever leaving your machine."), /* @__PURE__ */ React.createElement("div", { className: "hero-actions" }, /* @__PURE__ */ React.createElement(CopyCmd, { cmd: "uvx nable" })), /* @__PURE__ */ React.createElement("p", { className: "hero-cmdnote" }, "Runs locally. Reads your bill, changes nothing. No signup, no cloud keys to start."), /* @__PURE__ */ React.createElement("p", { className: "hero-trustline" }, /* @__PURE__ */ React.createElement("b", null, "Clouds, SaaS and AI spend"), " normalized into one bill \xB7 works in any editor \xB7 free for solo use"))));
}
