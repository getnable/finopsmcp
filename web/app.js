...
function FootCta() {
  return /* @__PURE__ */ React.createElement("section", { className: "foot-cta", id: "cta" }, /* @__PURE__ */ React.createElement("div", { className: "foot-cta-grid" }), /* @__PURE__ */ React.createElement("div", { className: "wrap", style: { position: "relative" } }, /* @__PURE__ */ React.createElement("div", { className: "eyebrow", style: { marginBottom: 32, display: "inline-flex" } }, /* @__PURE__ */ React.createElement("span", { className: "d" }), " Free tier \xB7 no credit card"), /* @__PURE__ */ React.createElement("h2", { className: "display" }, "Your whole cloud and AI bill.", /* @__PURE__ */ React.createElement("br", null), /* @__PURE__ */ React.createElement("em", null, "One question away.")), /* @__PURE__ */ React.createElement("div", { style: { marginTop: 44, display: "flex", flexDirection: "column", alignItems: "center", gap: 22 } }, /* @__PURE__ */ React.createElement("div", { className: "foot-install" }, /* @__PURE__ */ React.createElement(CopyCmd, { cmd: "uvx nable" })), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 14, flexWrap: "wrap", justifyContent: "center" } }, /* @__PURE__ */ React.createElement(
    "a",
    {
      href: "/docs.html#install",
      className: "btn btn-primary",
    ...
    "Book a live demo"
  ))), /* @__PURE__ */ React.createElement("p", { style: { marginTop: 32, fontSize: 13, color: "var(--fg-3)" } }, "Building something? ", /* @__PURE__ */ React.createElement("a", { href: "/about", style: { color: "var(--accent-dim)" } }, "Read the founder note and investor thesis \u2192"))));
}
